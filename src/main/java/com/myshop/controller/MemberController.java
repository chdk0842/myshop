...
public class MemberController {
	...
	// 쿠키, 세션 테스트
	/*
	 * @PostMapping(value = "/login2") public String
	 * loginMember2(HttpServletResponse response, HttpSession session, @RequestParam
	 * String email) { System.out.println("email: " + email); Cookie idCookie = new
