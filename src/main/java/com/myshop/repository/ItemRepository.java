...
public interface ItemRepository extends JpaRepository<Item, Long>,
	...
	/*
	 * // 퀴즈1-1 // select * from item where item_nm = ? || itemSellStatus = SELL
	 * List<Item> findByItemNmAndItemSellStatus(String itemNm, ItemSellStatus
	 * ItemSellStatus);
	 * 
	 * // 퀴즈1-2 // select * from item where price <= 10004 || price >= 10008
	 * List<Item> findByPriceBetween(Integer price, Integer price1);
	 * 
	 * // 퀴즈1-3 // select * from item where regTime < 2023-1-1 12:12:44 List<Item>
	 * findByRegTimeAfter(LocalDateTime regTime);
	 * 
	 * // 퀴즈1-4 // select * from item where ItemSell not null List<Item>
	 * findByItemSellStatusNotNull();
	 * 
	 * // 퀴즈1-5 // select * from item like ItemDetail(%설명1) List<Item>
	 * findByItemDetailEndingWith(String ItemDetail);
	 */
